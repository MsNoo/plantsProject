<header>
    ...
    <div class="navigationBar">
        <nav>
            ...
            <a href="./galleryAdmin.php" class="navBarFonts" style="text-decoration: none;">Plants Edit</a>
            ...
            <a href="./dataAdmin.php" class="navBarFonts" style="text-decoration: none;">Data</a>
        ...
        <div class="child1">
            ...
            <a href="" class="navBarFonts" style="text-decoration: none; "><?php echo $_SESSION["username"] ?></a>
        </div>
    </div>
    <div class="quoteFeat">
        <?php
        if (strpos($_SERVER['REQUEST_URI'], 'index.php') !== false) { ?>
            <h2 class="titleh2">Welcome <?php echo $_SESSION["username"] ?></h2>
        <?php } else { ?>
